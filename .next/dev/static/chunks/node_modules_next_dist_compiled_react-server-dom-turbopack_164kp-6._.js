      ...
      (function () {
          ...
          switch (typeof value) {
            ...
            case "string":
              value =
                ...
                value
                  ? "\u2026"
                  : JSON.stringify(1024 <= value.length ? value.slice(0, 1023) + "\u2026" : value);
              break;
            case "undefined":
              value = "undefined";
              break;
        ...
        function resolveModuleChunk(response, chunk$jscomp$0, value) {
          if ("pending" === chunk$jscomp$0.status || "blocked" === chunk$jscomp$0.status) {
            ...
            null !== debugInfo &&
              chunk$jscomp$0._debugInfo.push.apply(chunk$jscomp$0._debugInfo, debugInfo);
            null !== resolveListeners &&
              (initializeModuleChunk(chunk$jscomp$0),
              wakeChunkIfInitialized(response, chunk$jscomp$0, resolveListeners, rejectListeners));
          }
        }
          ...
          var name = errorInfo.name,
            ...
            errorOptions =
              "cause" in errorInfo
                ...
                : void 0,
            isAggregateError = "undefined" !== typeof AggregateError && "errors" in errorInfo,
                    ...
                    if ("string" === typeof _candidateInfo.name) {
                      ...
                      if (supportsUserTiming && 0 < endTime$jscomp$1) {
                        var entryName$jscomp$3 =
                          ...
                          debugTask$jscomp$2 =
                            asyncInfo$jscomp$1.debugTask || asyncInfo$jscomp$1.awaited.debugTask;
        ...
        function createResponseFromOptions(options) {
          var debugChannel =
              options && void 0 !== options.debugChannel
                ...
                : void 0,
            callServer = options && options.callServer ? options.callServer : void 0,
            temporaryReferences =
            ...
            environmentName = options && options.environmentName ? options.environmentName : void 0,
            debugStartTime = options && null != options.startTime ? options.startTime : void 0;
