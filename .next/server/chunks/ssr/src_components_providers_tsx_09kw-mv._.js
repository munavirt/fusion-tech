module.exports = [
  ...
  (a) => {
    ...
    function n(a, b) {
      ...
      if (g) {
        if (d) {
          if (b.queryHash !== p(g, b.options)) return !1;
        } else if (!r(b.queryKey, g)) return !1;
      }
      if ("all" !== c) {
        let a = b.isActive();
    ...
    function o(a, b) {
      ...
      if (f) {
        ...
        if (c) {
          if (q(b.options.mutationKey) !== q(f)) return !1;
        } else if (!r(b.options.mutationKey, f)) return !1;
      }
      return (!d || b.state.status === d) && (!e || !!e(b));
    }
    function p(a, b) {
      return (b?.queryKeyHashFn || q)(a);
    }
    function q(a) {
    ...
    function r(a, b) {
      ...
      if (a && b && "object" == typeof a && "object" == typeof b) {
        if (Array.isArray(a) && Array.isArray(b)) {
          for (let c = 0; c < b.length; c++) if (!r(a[c], b[c])) return !1;
          return !0;
        }
        for (let c of Object.keys(b)) if (!r(a[c], b[c])) return !1;
        return !0;
      }
      return !1;
    }
    ...
    function G(a) {
      return (a ?? "online") !== "online" || D.isOnline();
    }
    ...
    function I(a) {
      let b,
        ...
        f = () => C.isFocused() && ("always" === a.networkMode || D.isOnline()) && a.canRun(),
        g = () => G(a.networkMode) && a.canRun(),
        h = (a) => {
    ...
    var J = class {
      ...
      updateGcTime(a) {
        this.gcTime = Math.max(this.gcTime || 0, a ?? (E.isServer() ? 1 / 0 : 3e5));
      }
      clearGcTimeout() {
        void 0 !== this.#g && (k.clearTimeout(this.#g), (this.#g = void 0));
      }
    };
    function K(a, { pages: b, pageParams: c }) {
      let d = b.length - 1;
    ...
    var L = class extends J {
      ...
      setOptions(a) {
        if (
          ...
          let a = N(this.options);
          void 0 !== a.data && (this.setState(M(a.data, a.dataUpdatedAt)), (this.#i = a));
        }
      }
      optionalRemove() {
      ...
      cancel(a) {
        ...
        return (this.#m?.cancel(a), b ? b.then(l).catch(l) : Promise.resolve());
      }
      destroy() {
      ...
      isDisabled() {
        return this.getObserversCount() > 0
          ? !this.isActive()
          : this.options.queryFn === y || !this.isFetched();
      }
      isFetched() {
      ...
      isStatic() {
        return (
          ...
          this.observers.some((a) => "static" === m(a.options.staleTime, this))
        );
      }
      isStale() {
        return this.getObserversCount() > 0
      ...
      async fetch(a, b) {
        ...
        let e = new AbortController(),
          f = (a) => {
            Object.defineProperty(a, "signal", {
              enumerable: !0,
              get: () => ((this.#o = !0), e.signal),
            });
          },
          g = () => {
            let a,
              c = z(this.options, b),
              d = (f((a = { client: this.#l, queryKey: this.queryKey, meta: this.meta })), a);
                    ...
                    let d = a.options,
                      ...
                      j = async () => {
                        ...
                        if (e && f.length) {
                          ...
                          let a = c ?? f.length;
                          do {
                            let a = 0 === i ? (g[0] ?? d.initialPageParam) : K(d, h);
                            if (i > 0 && null == a) break;
                            ((h = await k(h, a)), i++);
                          } while (i < a);
                        }
        ...
        (i?.onFetch(h, this),
          ...
          (this.#m = I({
            ...
            fn: h.fetchFn,
            onCancel: (a) => {
              (a instanceof H && a.revert && this.setState({ ...this.#j, fetchStatus: "idle" }),
                e.abort());
            },
            onFail: (a, b) => {
            ...
            case "fetch":
              ...
              return {
                ...
                ...((c = b.data),
                {
                  ...
                  fetchStatus: G(this.options.networkMode) ? "fetching" : "paused",
    ...
    var O = class extends B {
        ...
        findAll(a = {}) {
          let b = this.getAll();
          return Object.keys(a).length > 0 ? b.filter((b) => n(a, b)) : b;
        }
        notify(a) {
          A.batch(() => {
            this.listeners.forEach((b) => {
      ...
      P = class extends J {
        ...
        async execute(a) {
          let b = () => {
            ...
            c = { client: this.#l, meta: this.options.meta, mutationKey: this.options.mutationKey };
          this.#m = I({
            fn: () =>
      ...
      Q = class extends B {
        constructor(a = {}) {
          (super(), (this.config = a), (this.#u = new Set()), (this.#v = new Map()), (this.#w = 0));
        }
        #u;
        #v;
        #w;
        ...
        find(a) {
          let b = { exact: !0, ...a };
          return this.getAll().find((a) => o(b, a));
        }
        findAll(a = {}) {
          return this.getAll().filter((b) => o(a, b));
        }
        notify(a) {
          A.batch(() => {
            this.listeners.forEach((b) => {
        ...
        resumePausedMutations() {
          ...
          return A.batch(() => Promise.all(a.map((a) => a.continue().catch(l))));
        }
      };
    function R(a) {
    ...
    var S = class {
        ...
        #C;
        constructor(a = {}) {
          ((this.#x = a.queryCache || new O()),
            (this.#t = a.mutationCache || new Q()),
            (this.#n = a.defaultOptions || {}),
            (this.#y = new Map()),
            (this.#z = new Map()),
            (this.#A = 0));
        ...
        mount() {
          (this.#A++,
            1 === this.#A &&
              ((this.#B = C.subscribe(async (a) => {
                a && (await this.resumePausedMutations(), this.#x.onFocus());
              })),
              (this.#C = D.subscribe(async (a) => {
        ...
        ensureQueryData(a) {
          ...
          return void 0 === d
            ? this.fetchQuery(a)
            : (a.revalidateIfStale && c.isStaleByTime(m(b.staleTime, c)) && this.prefetchQuery(b),
              Promise.resolve(d));
        }
        getQueriesData(a) {
        ...
        cancelQueries(a, b = {}) {
          let c = { revert: !0, ...b };
          return Promise.all(A.batch(() => this.#x.findAll(a).map((a) => a.cancel(c))))
            .then(l)
            .catch(l);
        }
        ...
        fetchQuery(a) {
          ...
          return c.isStaleByTime(m(b.staleTime, c)) ? c.fetch(b) : Promise.resolve(c.state.data);
        }
        prefetchQuery(a) {
          return this.fetchQuery(a).then(l).catch(l);
        }
        fetchInfiniteQuery(a) {
          return ((a._type = "infinite"), this.fetchQuery(a));
        }
        prefetchInfiniteQuery(a) {
          return this.fetchInfiniteQuery(a).then(l).catch(l);
        }
        ...
        setQueryDefaults(a, b) {
          this.#y.set(q(a), { queryKey: a, defaultOptions: b });
        }
        getQueryDefaults(a) {
          let b = [...this.#y.values()],
            c = {};
          return (
            b.forEach((b) => {
              r(a, b.queryKey) && Object.assign(c, b.defaultOptions);
            }),
            c
          );
        }
        setMutationDefaults(a, b) {
          this.#z.set(q(a), { mutationKey: a, defaultOptions: b });
        }
        getMutationDefaults(a) {
          ...
          return (
            b.forEach((b) => {
              r(a, b.mutationKey) && Object.assign(c, b.defaultOptions);
            }),
            c
          );
        }
        defaultQueryOptions(a) {
          ...
          return (
            b.queryHash || (b.queryHash = p(b.queryKey, b)),
      ...
      V = ({ client: a, children: b }) => (
        ...
        (0, i.jsx)(U.Provider, { value: a, children: b })
      ),
      W = a.i(92664);
    a.s(
      [
        ...
        0,
        function ({ children: a }) {
          let [b] = (0, T.useState)(() => new S());
          return (0, i.jsx)(V, {
            client: b,
            children: (0, i.jsx)(W.EnvironmentProvider, { children: a }),
          });
        },
      ],
      18175,
...
//# sourceMappingURL=src_components_providers_tsx_09kw-mv._.js.map
