...
const rooms = [
  ...
  },
  {
    ...
    x: "24%",
    y: "28%",
    items: ["Lighting scenes", "Smart curtains", "AC control", "Smart access"],
  },
  {
    key: "kitchen",
    name: "Kitchen",
  ...
  },
  {
    ...
    x: "82%",
    y: "78%",
    items: ["Landscape lighting", "Irrigation automation", "CCTV monitoring"],
  },
  {
    key: "garage",
    ...
    x: "12%",
    y: "82%",
    items: ["Automated shutter", "Gate automation", "Smart door locks", "Access control"],
  },
  {
    key: "office",
    name: "Office",
